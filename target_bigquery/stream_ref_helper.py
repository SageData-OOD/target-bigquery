...
class StreamRefHelper:
    ...
    def table_ref_from_stream(self,
        ...
        # get table id
        table_id = self.table_id_from_stream(stream_name, tables_prefix)
